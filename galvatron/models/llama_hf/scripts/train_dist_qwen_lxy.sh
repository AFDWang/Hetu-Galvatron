...
TRAINER="train_dist_profiler.py"
...
PARALLEL_ARGS="
    ...
    #--galvatron_config_path /home/galvatron_dev/lqs/Hetu-Galvatron/galvatron/models/llama_hf/configs/galvatron_config_qwen2.5-3b_1nodes_8gpus_per_node_24GB_bf16_[tpconsec_off]_4096.json"
#--sequence-parallel \
