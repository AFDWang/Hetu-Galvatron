def model_args(parser):
    ...
    group.add_argument(
        "--model_size", type=str, default='t5-small', help="Model size.", choices=['t5-small', 't5-base', 't5-large', 't5-3B']
    )
    group.add_argument(
    ...
    group.add_argument(
        "--encoder_seq_length", type=int, default=512, help="Maximum encoder sequence len"
    )
    group.add_argument(
        "--decoder_seq_length", type=int, default=512, help="Maximum decoder sequence len"
    )
    group.add_argument(
